 ...
 * @since 2.1.6
 */
public class TSAClientBouncyCastleCustom implements TSAClient {
...
private String hashAlgo;
   ...
   */
  public TSAClientBouncyCastleCustom(String url, String hashAlgo) {
    this(url, null, null, 4096, hashAlgo);
  }
   ...
   *          String - password
   */
  public TSAClientBouncyCastleCustom(String url, String username, String password, String hashAlgo) {
    this(url, username, password, 4096, hashAlgo);
  }
   ...
   */
  public TSAClientBouncyCastleCustom(String url, String username, String password,
      int tokSzEstimate, String hashAlgo) {
    this.tsaURL = url;
  ...
  protected byte[] getTimeStampToken(byte[] imprint) throws Exception {
    ...
    try {
      ...
      TimeStampRequest request = tsqGenerator.generate(
    		  InsignPdfPKCS7.getAllowedDigests().get(hashAlgo), imprint, nonce);
